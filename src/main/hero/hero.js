...
const SubDescription = styled(Title)`
  padding-top: 0.5em;
  line-height: 30px;
  font-size: 20px;
  color: ${(props) => props.theme.colors.letter};
      ...
      <Content>
        <Intro>
          ...
          <SubTitle
            ...
            transition={{ duration: 1 }}>
            A <span>Software Engineer</span> building amazing stuff.
          </SubTitle>
          <Description
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ duration: 2 }}>
            Full stack engineer (frontend heavy) with over 6 years experience.{" "}
            <SubDescription>
              I like to craft and design solid and scalable frontend
              applications that are not just visually appealing, but offer great
              user experiences.
            </SubDescription>
          </Description>
        </Intro>
